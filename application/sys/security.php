...
class security
{
    ...
    function __construct()
    {
        ...
        //check GET
        if(!$this->cycleGET())
			unset($_GET); //unset because get usually isnt used

        //check post, if unsafe a value will be set to ---------
        $this->cyclePOST();

    
        //session stuff
        if (isset($_SESSION['HUA']))//HTTP_USER_AGENT
        {
...
//A few functions stoled from code igniter :/
