...
{	
	...
	public function display()
    {
        ...
        if($this->error)
        {
            ...
            if($this->message != FALSE)echo '<div class="error">'.$this->message.'</div>'."\n";
            
            $form = '<form class="form" '.$this->action.' method="post">'."\n";
            echo $form."\n <fieldset>";
            if($this->title != "")
            ...
            $this->display_inputs();
            echo '<input name="submit" type="submit" value="submit" id="submit" />';   
            echo '</fieldset>';
            echo "\n".'</form>';
        }
        else
